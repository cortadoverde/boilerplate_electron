...
System.register('app/controller/wrappController', ['npm:babel-runtime@5.6.15/helpers/class-call-check'], function (_export) {
  var _classCallCheck, wrappController;
  ...
  return {
    ...
    execute: function () {
      ...
      wrappController = function wrappController($scope, $rootScope) {
        _classCallCheck(this, wrappController);
      ...
      _export('wrappController', wrappController);
    }
  };
});
System.register('app/bootstrap', ['github:angular/bower-angular@1.4.1', 'app/controller/wrappController'], function (_export) {
    'use strict';

    var angular, wrappController, app;
    return {
        setters: [function (_githubAngularBowerAngular141) {
            angular = _githubAngularBowerAngular141['default'];
        }, function (_appControllerWrappController) {
            wrappController = _appControllerWrappController.wrappController;
        }],
        execute: function () {
...
//# sourceMappingURL=boilerplate_atom.js.map